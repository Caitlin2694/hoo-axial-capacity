          ...
          <v-row align="center" justify="center">
            <v-col cols="12" md="6" xl="8">
              ...
              <!--<div class="video d-flex align-center py-4">
                ...
                <p class="subheading ml-2 mb-0">Watch our tutorial video</p>
              </div>-->
            </v-col>
      ...
      features: [
        {
          ...
          title: "Collaborators",
          text: "The Unified methods were developed as part of a joint Industry project (JIP) managed by the Norwegian Geotechnical Institute in collaboration with The University of Western Australia. The JIP was supported by Equinor, Lundin Oil, Ørsted, ONGC, BP, TOTAL, ExxonMobil, EnBW, EDF, Aramco, SSER & HDEC.",
        },
        {
          img: require("@/assets/img/icon2.png"),
          title: "Description of the Unified CPT method",
          text: "The formulations employed by the program are fully described in the following publications: Lehane et al.(2020): Sand method Lehane et al. (2021): Clay and silt method",
        },
      ],
    };
  },
